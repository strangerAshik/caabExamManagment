...
<div class="row">
   <div class="col-md-12">
        ...
        {!!Form::open(array('url'=>'examShedule/updateShedule/','method'=>'post','class'=>'form-horizontal','data-toggle'=>'validator','role'=>'form','files'=>'true'))!!}
          {!! csrf_field() !!}
          <input type="hidden" name="id" value="{{$details->id}}">
         <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">Title</label>
            <div class="col-sm-5">
               <input type="text" name="title" value="{{$details->title}}" class="form-control"  placeholder=" ">
            </div>
         </div>
         <div class="form-group">      
            ...
            <div class="col-sm-4">
               <select placeholder="" name="licence_type" class="form-control">
                   <option value="">Select Licence Type..</option>
                    ...
                    <option <?php if($info->id==$details->licence_type) echo "selected=''"?> value="{{$info->id}}">{{$info->licence_type}}</option>
                    @endforeach
               </select>
            </div>
         </div>
               ...
               <select placeholder="" name="subject" class="form-control">
                   <option value="">Select Subject..</option>
                     @foreach($subjects as $info)
                       <option <?php if($info->id==$details->subject) echo "selected=''"?> value="{{$info->id}}">{{$info->subject.' ( '.$info->licence_type.' ) '}}</option>
                     @endforeach
               </select>
            </div>
         </div>
         <div class="form-group">
            ...
            <div class="col-sm-4">
               <div class="input-group">
                  ...
                  <input name="exam_date" value="{{$details->exam_date}}"type='text' class="form-control dateExam" placeholder="DD/MM/YYYY"/>
               </div>
            </div>
         </div>
         <div class="form-group">
            ...
            <div class="col-sm-4">
               <div class="input-group">
                  ...
                  <input name="start_time" value="{{$details->start_time}}" type='text' class="form-control timeExam" placeholder=""/>
               </div>
            </div>
         </div>
         <div class="form-group">
            ...
            <div class="col-sm-4">
               <div class="input-group">
                  <div class="input-group-addon glyphicon glyphicon-time"></div>
                  <input name="end_time" value="{{$details->end_time}}" type='text' class="form-control timeExam" placeholder=""/>
               </div>
            </div>
         </div>
         <div class="form-group">
            ...
            <div class="col-sm-4">
               <input name="total_question" value="{{$details->total_question}}" type="number" min="0" set="1" name="" class="form-control"  placeholder="">
            </div>
         </div>
         <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">Total Sit</label>
            <div class="col-sm-4">
               <input name="total_sit" value="{{$details->total_sit}}" type="number" min="0" set="1" name="" class="form-control"  placeholder="">
            </div>
         </div>
         <div class="form-group">
