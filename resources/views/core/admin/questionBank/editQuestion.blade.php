...
<div class="row">
	...
	{!!Form::open(array('url'=>'questionBank/updateQuestion','method'=>'post','class'=>'form-horizontal','data-toggle'=>'validator','role'=>'form','files'=>'true'))!!}
                     {!! csrf_field() !!}
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-2">
		  ...
		  @foreach($licenceTypes as $info)
		  	@if($info->id==$question->licence_type)
	    ...
	    <div class="col-sm-2">
		  ...
		  @foreach($chapters as $info)
		  	@if($info->id==$question->chapter)
		  	<option selected="" value="{{$info->id}}" >{{$info->chapter.'( '.$info->licence_type . ' / '.$info->subject.' ) ' }}</option>
		  	@else
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-6">
	    	<textarea  required="true" name="question"  class="form-control" rows="3" cols="5"  value="{{old('question')}}"><?php echo $question->question;?></textarea>
	  ...
	  <div class="form-group">
		   <label for="inputEmail3" class="col-sm-2 control-label">Option-1</label>
		    <div class="col-sm-4">
		       <input required="" type="text"name="option_1" value="{{$question->option_1}}" class="form-control"  placeholder=" ">
		    </div>

		   <label for="inputEmail3" class="col-sm-2 control-label">Option-2</label>
		    <div class="col-sm-4">
		       <input required="" type="text"name="option_2" value="{{$question->option_2}}" class="form-control"  placeholder=" ">
		    </div>
	  </div>
	  ...
	  <div class="form-group">
		   <label for="inputEmail3" class="col-sm-2 control-label">Option-3</label>
		    <div class="col-sm-4">
		       <input required="" type="text" name="option_3" value="{{$question->option_3}}" class="form-control"  placeholder=" ">
		    </div>

		   <label for="inputEmail3" class="col-sm-2 control-label">Option-4</label>
		    <div class="col-sm-4">
		       <input required="" type="text"name="option_4" value="{{$question->option_4}}" class="form-control"  placeholder=" ">
		    </div>
	  </div>
